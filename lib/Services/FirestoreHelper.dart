...
import 'package:boncoin/Model/Annonce.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:firebase_storage/firebase_storage.dart';
import 'package:boncoin/Model/Utilisateur.dart';
...
class FirestoreHelper {
  ...
  final fire_annonces = FirebaseFirestore.instance.collection("Annonces");
  ...
  //Méthodes
  Future <Utilisateur> createUser(String nom, DateTime birthday,
      String password, String mail, String prenom) async {
  ...
  Future <String> stockageImage(Uint8List bytes, String name) async {
    ...
    TaskSnapshot taskSnapshot = await storage.ref("ProfilImage/$nameFinal")
        .putData(bytes);
